<template>
  <nav class="bg-white h-[var(--nav-height)] border-gray-200 border-b bg-opacity-40 fixed top-0 w-full backdrop-blur z-50">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <RouterLink to="/" class="flex items-center space-x-3 rtl:space-x-reverse">
        <img src="../assets/images/cloud.svg" class="h-8" alt="MyCloud Logo" />
