...
<template>
  <li
    v-if="dir() != '/'"
    class="py-2 px-4 first:rounded-t-lg last:rounded-b-lg border-b border-gray-500 last:border-b-0 flex items-center justify-between"
  >
    <!-- File/Directory name and icon -->
    <div class="flex items-center space-x-3 w-full">
      <FolderIcon class="text-gray-300" />
      <RouterLink
        class="transition hover:text-blue-400 w-full block"
        :to="calcPath()"
      >
        ..
      </RouterLink>
