<template>
  <ModalUtil :show="true" @close="emit('close')">
    ...
    <div class="text-left my-2" v-if="show == 'selector'">
      <ButtonBluish @click="show = 'information'" class="my-1.5"
        >Information</ButtonBluish
      >
      <ButtonBluish @click="show = 'edit'" class="my-1.5"
        >Edit information</ButtonBluish
      >
