...
<template>
  <SpaceLayout>
    <div class="flex items-center justify-between">
      ...
      <buttons-button-pinkle @click="createModal = true" class="!w-min"
        >Create</buttons-button-pinkle
      >
    </div>
    ...
    <ul class="mt-5">
      ...
      >
        ...
        <buttons-button-bluish :to="`/spaces/${space.id}`" class="!w-min"
          >Open</buttons-button-bluish
        >
      </li>
    </ul>
  </SpaceLayout>
